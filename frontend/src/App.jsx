...
export default function App() {
  ...
  const [isDrawerExpanded, setIsDrawerExpanded] = useState(false); // Collapsed by default to not block map
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', backgroundColor: '#070A12', color: '#F1F5F9', overflow: 'hidden', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      {/* LEFT SIDEBAR */}
      <div style={{ width: '360px', minWidth: '360px', backgroundColor: '#0D1424', borderRight: '1px solid #1E293B', padding: '18px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', zIndex: 20 }}>
      ...
      {/* RIGHT MAIN VIEWPORT */}
      <div style={{ flex: 1, position: 'relative', height: '100%', width: '100%', backgroundColor: '#070A12', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, position: 'relative', width: '100%', height: '100%', overflowY: 'auto' }}>
          ...
          {activeTab === 'prediction' && (
            <div style={{ width: '100%', height: '100%', position: 'relative' }}>
              ...
              {/* NON-OBSTRUCTIVE FLOATING EVACUATION CONTROLLER (TOP-RIGHT MINI BADGE + EXPANDABLE DRAWER) */}
              {evacuationActive && selectedZone.evacuationPlan && (
                <div style={{ position: 'absolute', top: '80px', right: '16px', width: isDrawerExpanded ? '360px' : 'auto', zIndex: 1000, transition: 'all 0.3s ease' }}>
                  
                  {/* Minimized Pill Badge (Zero map blockage) */}
                  {!isDrawerExpanded ? (
                    <div 
            ...
            <div style={{ padding: '90px 28px 120px 28px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  <p style={{ margin: '4px 0 0', fontSize: '12px', color: '#94A3B8' }}>Bi-directional Sensor Hub: <code>ws://localhost:8000/ws/telemetry</code></p>
                </div>
          ...
          {activeTab === 'analytics' && (
            <div style={{ padding: '90px 28px 120px 28px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <div style={{ backgroundColor: '#0D1424', border: '1px solid #1E293B', padding: '24px', borderRadius: '16px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', borderTop: '1px solid #1E293B', paddingTop: '14px', marginTop: '12px', fontSize: '11px' }}>
        ...
        <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px', zIndex: 1000, backgroundColor: 'rgba(13, 20, 36, 0.95)', border: '1px solid #1E293B', padding: '16px', borderRadius: '16px', backdropFilter: 'blur(10px)', boxShadow: '0 20px 40px rgba(0,0,0,0.6)' }}>
